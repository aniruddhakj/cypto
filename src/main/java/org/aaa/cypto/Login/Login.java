...
public class Login {
    ...
    {
        String s = "";
        FileReader reader = new FileReader("/Users/aniruddhakj/Desktop/Java Lab/cypto/src/main/java/org/aaa/cypto/USERDATA.json");
    ...
    public void SignUp(Account acc) throws JSONException
    {
        ...
        try {
            reader = new FileReader("/Users/aniruddhakj/Desktop/Java Lab/cypto/src/main/java/org/aaa/cypto/UserAccount_Data.json");
        ...
        FileWriter file2;
        try {
            file2 = new FileWriter("/Users/aniruddhakj/Desktop/Java Lab/cypto/src/main/java/org/aaa/cypto/UserAccount_Data.json");
